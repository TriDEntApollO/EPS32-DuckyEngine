...
private:
    ...
    std::map<std::string, MediaKeyReport> mediaKeyMap; // Mapping of media key names to HID key codes.
    ...
    std::variant<uint8_t, MediaKeyReport> getKey(const std::string& key);
